                        ...
                        <form onSubmit={formSubmit} className="register-form">
                            ...
                            <div className="form-same-row">
                                <input
                                    ...
                                    disabled={!isEdit}
                                />
                                <select disabled={!isEdit} name="gender" value={formDetails.gender} className="form-input" id="gender" onChange={inputChange}>
                            ...
                            {isEdit && (
                                <div>
                                    ...
                                    <div style={{ textAlign: "center", fontSize: "0.8rem", color: "#ee0000" }}>
                                        *Enter your old password if you don't want to update your password!
                                    </div>
                                </div>
                            )}
                            {!isEdit ? (
                                <div className="flex-between">
                                    <NavLink to={"/"} className="btn form-btn">
                                        Back
                                    </NavLink>
                                    <button onClick={() => setIsEdit(!isEdit)} className="btn form-btn">
                                        Edit
                                    </button>
                                </div>
                            ) : (
